<template>
  <div class="flex bg-gray-50 border-t-1">
    <a
      class="flex-1 flex py-4 justify-center cursor-pointer items-center"
      :href="links.vcard"
      download
    >
    ...
    >
      ...
      <g-icon icon="mdi:share-variant" class="text-gray-600 pl-2"></g-icon>
    </div>
    <div
      class="flex-1 flex py-4 justify-center cursor-pointer items-center"
      @click="toogleQrCode"
    >
      <span class="text-sm"> Codigo qr </span>
